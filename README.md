...
binary protocol.
Code generated by the **AdHoc** server according to your protocol description file.
You just have to implement the received packet handlers and packet-producing logic, fill packs with data and send them
to the recipient.
