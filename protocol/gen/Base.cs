...
public interface Base
{
    ...
    {
        public Transmitter(int power_of_2_sending_queue_size) { }

        public ulong[] _ulong_array;
        public byte[] _byte_array;
        public Agent.AdHocProtocol.LayoutFile_.Info.XY[] _Agent_AdHocProtocol_LayoutFile__Info_XY_array;

        public void clear()
        {
            _ulong_array = null;
            _byte_array = null;
            _Agent_AdHocProtocol_LayoutFile__Info_XY_array = null;
            #region> Clear custom code
            #endregion> Base.Transmitter.Clear.Code
        }
        #region> Custom code
        #endregion> Base.Transmitter.Code
        ...
        public class Slot
        {
            ...
            {
                #region> Clear custom code
                #endregion> Base.Transmitter.Slot.Clear.Code

            }
            #region> Custom code
            #endregion> Base.Transmitter.Slot.Code

            public uint state;
            private readonly AdHoc.Channel.Transmitter dst;
            public Slot(AdHoc.Channel.Transmitter dst) { this.dst = dst; }
            #region 0
            public int index0;
            ...
            public bool no_items(int items, int items_max)
            {
                ...
                if (items_max < items)
                {
                    AdHoc.Channel.Transmitter.error_handler.error(dst, AdHoc.Channel.Transmitter.OnError.OVERFLOW, new ArgumentOutOfRangeException("In no_items(uint items, uint items_max, uint next_field_case)     items_max < items : " + items_max + " < " + items));
    ...
    class Receiver : AdHoc
    {
        ...
        {
            #region> Clear custom code
            #endregion> Base.Receiver.Clear.Code

        }
        #region> Custom code
        #endregion> Base.Receiver.Code
        ...
        public class Slot
        {
            ...
            {
                #region> Clear custom code
                #endregion> Base.Receiver.Slot.Clear.Code

            }
            #region> Custom code
            #endregion> Base.Receiver.Slot.Code
            ...
            public uint state;
            private readonly AdHoc.Channel.Receiver src;
            public Slot(AdHoc.Channel.Receiver src) { this.src = src; }
            #region 0
            public int index0;
            ...
            public bool find_exist0(int index0)
            {
                ...
                if (nulls == 0)
                    return false;
                if (index_max0 <= (this.index0 = index0 + trailing8Zeros(nulls)))
                    AdHoc.Channel.Receiver.error_handler.error(src, AdHoc.Channel.Receiver.OnError.OVERFLOW, new ArgumentOutOfRangeException("In the find_exist0(){} index_max0 <= index0 : " + index_max0 + " < " + this.index0));
            ...
            public void check_len0(int len)
            {
                if (max_items < index_max_0(len))
                    AdHoc.Channel.Receiver.error_handler.error(src, AdHoc.Channel.Receiver.OnError.OVERFLOW, new ArgumentOutOfRangeException("In get_len0  (uint max_items, uint bytes, uint next_case){}   max_items < index_max0 : " + max_items + " < " + index_max0));
            }
            #endregion
            #region 1
            public int index1;
            ...
            public bool find_exist1(int index1)
            {
                ...
                if (nulls == 0)
                    return false;
                if (index_max1 <= (this.index1 = index1 + trailing8Zeros(nulls)))
                    AdHoc.Channel.Receiver.error_handler.error(src, AdHoc.Channel.Receiver.OnError.OVERFLOW, new ArgumentOutOfRangeException("In the find_exist1(){} index_max1 <= index1 : " + index_max1 + " < " + this.index1));
            ...
            public void check_len1(int len)
            {
                if (max_items < index_max_1(len))
                    AdHoc.Channel.Receiver.error_handler.error(src, AdHoc.Channel.Receiver.OnError.OVERFLOW, new ArgumentOutOfRangeException("In get_len1  (uint max_items, uint bytes, uint next_case){}   max_items < index_max1 : " + max_items + " < " + index_max1));
            }
            #endregion
            #region 2
            public int index2;
            ...
            public bool find_exist2(int index2)
            {
                ...
                if (nulls == 0)
                    return false;
                if (index_max2 <= (this.index2 = index2 + trailing8Zeros(nulls)))
                    AdHoc.Channel.Receiver.error_handler.error(src, AdHoc.Channel.Receiver.OnError.OVERFLOW, new ArgumentOutOfRangeException("In the find_exist2(){} index_max2 <= index2 : " + index_max2 + " < " + this.index2));
            ...
            public void check_len2(int len)
            {
                if (max_items < index_max_2(len))
                    AdHoc.Channel.Receiver.error_handler.error(src, AdHoc.Channel.Receiver.OnError.OVERFLOW, new ArgumentOutOfRangeException("In get_len2  (uint max_items, uint bytes, uint next_case){}   max_items < index_max2 : " + max_items + " < " + index_max2));
            }
            #endregion
            ...
            public int items_count(int max_items)
            {
                ...
                if (max_items < items)
                {
                    AdHoc.Channel.Receiver.error_handler.error(src, AdHoc.Channel.Receiver.OnError.OVERFLOW, new ArgumentOutOfRangeException("In items_count  (uint max_items){}   max_items < items : " + max_items + " < " + items));
                    return 0;
                }
                return items;
            }
