...
public partial class Channel : AdHoc.Channel.Internal
{
    ...
    public class Transmitter : AdHoc.Channel.Transmitter, AdHoc.Channel.Transmitter.EventsHandler
    {
        ...
        public org.unirail.ObserverCommunication.Channel? channel;
        ...
        public Transmitter(org.unirail.ObserverCommunication.Channel channel, int power_of_2_sending_queue_size = 5) : base(null)
        {
        ...
        {
            public readonly org.unirail.ObserverCommunication.Channel channel;
            internal DataPass(org.unirail.ObserverCommunication.Channel channel) { this.channel = channel; }
    ...
    public class Receiver : AdHoc.Channel.Receiver
    {
        ...
        public Receiver(org.unirail.ObserverCommunication.Channel channel) : base(null, 1)
        {
            this.channel = channel;
        ...
        {
            #region> OnReceiving
            #endregion> Āā.Receiver.OnReceiving
            AdHoc.Channel.Receiver.BytesDst ret;
            switch (id)
            {
                case Agent.AdHocProtocol.LayoutFile_.Info.__id_:
                    receiving_data.dst = _Allocator.DEFAULT.new_AdHocProtocol_LayoutFile_Info(this);
                    ret = receiving_data.dst;
                    break;
                case Agent.AdHocProtocol.Observer_.Show_Code.__id_:
                    receiving_data.dst = Agent.AdHocProtocol.Observer_.Show_Code.Handler.ONE;
                    ret = receiving_data.dst;
                    break;
                case Agent.AdHocProtocol.Observer_.Up_to_date.__id_:
                    receiving_data.dst = _Allocator.DEFAULT.new_AdHocProtocol_Observer_Up_to_date(this);
                    ret = receiving_data.dst;
                    break;
