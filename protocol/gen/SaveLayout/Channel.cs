...
public partial class Channel : AdHoc.Channel.Internal
{
    ...
    public class Transmitter : AdHoc.Channel.Transmitter, AdHoc.Channel.Transmitter.EventsHandler
    {
        ...
        public org.unirail.SaveLayout.Channel? channel;
        ...
        public Transmitter(org.unirail.SaveLayout.Channel channel, int power_of_2_sending_queue_size = 5) : base(null)
        {
        ...
        {
            public readonly org.unirail.SaveLayout.Channel channel;
            internal DataPass(org.unirail.SaveLayout.Channel channel) { this.channel = channel; }
    ...
    public class Receiver : AdHoc.Channel.Receiver
    {
        ...
        public Receiver(org.unirail.SaveLayout.Channel channel) : base(null, 1)
        {
            this.channel = channel;
        ...
        protected override BytesDst _OnReceiving(int id)
        {
            ...
            switch (id)
            {
                ...
                case Agent.AdHocProtocol.LayoutFile_.UID.__id_:
                    receiving_data.dst = _Allocator.DEFAULT.new_AdHocProtocol_LayoutFile_UID(this);
                    ret = receiving_data.dst;
                    break;
